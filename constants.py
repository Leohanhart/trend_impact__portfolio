...
db_dir = "../core_data/flowimpact_api_db.db"
SQLALCHEMY_DATABASE_URI_layer_one = "sqlite:///" + os.path.abspath(db_dir)  # works

db_dir = "core_data/flowimpact_api_db.db"
SQLALCHEMY_DATABASE_URI_layer_zero = "sqlite:///" + os.path.abspath(db_dir)  # works

# removed : after sqlite "sqlite://"
SQLALCHEMY_DATABASE_URI_Test = "sqlite://" + os.path.abspath(db_dir) 
#### additional file paths for linking
CORE_UPDATE_ALL_ANALYSES_PATH = os.path.join(CORE_UPDATE___PATH, 'update_analyses')