...
# stock details
stock_avalible_analyses = 'stock_data', 'liquidity_data', 'moneyflow_data', 'time_serie_data'
...
# analyses details
analyses_time_series = ['indicator_timeserie_raw', 'indicator_timeserie_profile',
                        'indicator_timeserie_profile_change', 'indicator_timeserie_change']
analyses_single_vars = ['last_calculation_indicator', 'last_calculation_profile_indicator_text',
                        'last_calculation_profile_indicator_number', 'last_calculation_profile_change_text', 'last_calculation_profile_change_number']
...
db_dir = "../core_data/flowimpact_api_db.db"
SQLALCHEMY_DATABASE_URI_layer_one = "sqlite:///" + \
    os.path.abspath(db_dir)  # works

db_dir = "core_data/flowimpact_api_db.db"
SQLALCHEMY_DATABASE_URI_layer_zero = "sqlite:///" + \
    os.path.abspath(db_dir)  # works
