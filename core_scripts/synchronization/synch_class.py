...
# data_for_callculations    
    ...
    def __init__(self, path : str = "", subfolder : str = "", ticker : str = "", data_extention : str  = ""):
        """
        ...
        self.Full__filename = full_file_path #path +"\\" + subfolder +"\\" + ticker+ "."  + data_extention
        ...
        if self.is_data_new == True: 
            ...
            try:
                with open(self.Full__filename, 'wb') as handle:
                    ...
                    pickle.dump(self.new_data, handle, protocol=pickle.DEFAULT_PROTOCOL)
            ...
            try:
                with open(self.Full__filename, 'wb') as handle:
                    ...
                    pickle.dump(self.synchronized_data, handle, protocol=pickle.DEFAULT_PROTOCOL)
            ...
            if type(self.retreived_data) != str and type(self.new_data) != str:
                if type(self.retreived_data) != type(self.new_data):
                    self.error_code = "Types of data do not patch durring syncronisation"
                        ...
                        additional_frame = df2.iloc[end_location_old_data + 0: end_location_new_data ]
    ...
    def return_last_modification_file(self, difference : bool = True, view : str = "W", experiation_bool : bool = False):
        ...
        if self.is_data_new:
           ...
           raise Exception("Data is new. No data possible")
            ...
            date_object_lastM = datetime.strptime(modificationTime, "%Y-%m-%d").date()
           ...
           #print( weekNr_old,  " = Old weeks")
            ...
            if experiation_bool: 
                if view == "D":
                    ...
                    raise Exception("Data is new. Wrong formate, Qould happend if D or W is not used.")
...
if __name__ == "__main__":    
    ...
    try:
        ...
        try:
            ...
            synch_object = data_synch( path= constants.CORE_DATA_____PATH , subfolder = "stock_analyses_data", ticker = "SWN", data_extention = "WMONEYFLOWS_dictonary")
