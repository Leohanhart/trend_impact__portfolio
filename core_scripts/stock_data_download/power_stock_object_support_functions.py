...
class load_company_data_yahoo:
    ...
    def load_data(self):
        ...
        try:
            ...
            self.future_fair_value_including_dividends = self.load_future_fairvalue_price_including_dividends()
...
if __name__ == "__main__":    
    ...
    try:
        ...
        synch_object = synch_class.data_synch( path= constants.CORE_DATA_____PATH , subfolder = "stock_data", ticker = "AACG", data_extention = "last_download_company_data_refresh")
