...
def initialization():
    ...
    class portfolio(Base):
        ...
        list_of_tickers = Column(JSON, nullabled=False)
        list_of_balances = Column(JSON, nullabled=False)
        list_of_sides = Column(JSON, nullabled=False)
        list_of_performance = Column(JSON, nullabled=False)
