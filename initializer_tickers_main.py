...
if you want more checks. Add in check if ticker is capble.    
    ...
    def __init__(self, stock_ticker : str = None, auto_modus : bool = False):
        """
    ...
    def add_ticker_to_db(self): 
        ...
        try:
            ...
            # sleep for destressing the services
            time.sleep(2.6)
...
if __name__ == "__main__":    
    ...
    try:
        ...
        #infile_ = initiaze_singel_ticker("FRTA")
