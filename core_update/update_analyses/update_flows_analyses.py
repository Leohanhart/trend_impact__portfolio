...
class update_money_flow_analyses(object):
    ...
    def update_analyses():
        ...
        for ticker in tickers:
            ...
            try:
                update_money_flow_analyses.update_moneyflow_weekly_analyses(ticker)
            except Exception as e:
                continue 

    @staticmethod
    def update_moneyflow_weekly_analyses(ticker : str = ""):
...
if __name__ == "__main__":    
    ...
    try:
        ...
        print("START")
        update_money_flow_analyses.update_analyses()
